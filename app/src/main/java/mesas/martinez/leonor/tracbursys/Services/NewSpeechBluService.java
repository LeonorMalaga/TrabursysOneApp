 ...
 */
public class NewSpeechBluService extends IntentService implements BluetoothAdapter.LeScanCallback, TextToSpeech.OnInitListener{
...
public static enum State {
   ...
   private Device deviceaux;
    ...
    public NewSpeechBluService() {
        super(NewSpeechBluService.class.getName());
 ...
 //Start detect i-beacons
  ...
  public void setState(State state){
    ...
    protected void mstop(){
        ...
        if(start!=false){
            start = false;
            mBluetoothAdapter.stopLeScan(NewSpeechBluService.this);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch(action) {
                ...
                case Constants.SERVICE_STOP:
                    NewSpeechBluService.this.mstop();
...
// scan for SCAN_TIMEOUT
            mHandler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    NewSpeechBluService.this.setState(State.WAIT);
                    mBluetoothAdapter.stopLeScan(NewSpeechBluService.this);
                }
            }, SCAN_TIMEOUT);
            NewSpeechBluService.this.setState(State.SCANNING);
            mBluetoothAdapter.startLeScan(NewSpeechBluService.this);
    ...
    private void startScan() throws InterruptedException {
        ...
        if (mBluetoothAdapter== null || !mBluetoothAdapter.isEnabled()) {
            ...
            NewSpeechBluService.this.start();
        }
    }
